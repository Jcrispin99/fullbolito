        ...
        <DialogPortal>
            ...
            >
                <div class="flex items-center justify-between border-b px-6 py-4">
                    <div class="min-w-0">
                        ...
                        <DialogDescription class="text-xs text-muted-foreground">
                            Selecciona un lote específico o deja Auto (FEFO) para
                            asignación automática por vencimiento.
                        </DialogDescription>
                    </div>
                    <DialogClose
                ...
                <div class="flex-1 overflow-y-auto px-6 py-4 space-y-3">
                    <div v-if="!warehouseId" class="rounded-md border border-amber-300 bg-amber-50 px-3 py-2 text-xs text-amber-800">
                        Seleccione un almacén en la cabecera para ver los lotes disponibles.
                    </div>
                    ...
                    <div
                        ...
                        class="py-6 text-center text-sm text-muted-foreground"
                    >
                        <template v-if="search">No hay lotes que coincidan con "{{ search }}".</template>
                        <template v-else>No hay lotes disponibles para este producto en este almacén.</template>
                    </div>
