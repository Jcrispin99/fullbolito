...
class UbigeoDistrictSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->command->info('Insertando ' . count($districts) . ' distritos...');

        foreach (array_chunk($districts, 500) as $chunk) {
            DB::table('ubigeo_districts')->insert($chunk);
        }

        $this->command->info('✅ ' . count($districts) . ' distritos insertados correctamente');
    }
}
