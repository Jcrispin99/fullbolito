...
final class ModuleSeeder extends Seeder
{
    ...
    {
        $modules = [
            ['key' => 'dashboard',  'label' => 'Dashboard',          'icon' => 'layout-dashboard', 'sort_order' => 10],
            ...
            ['key' => 'builder',    'label' => 'Constructor de Sitio', 'icon' => 'layout-template', 'sort_order' => 80, 'addon_price' => 14.99],
        ];
