...
use App\Http\Controllers\Api\Tenant\V1\CourtController;
use App\Http\Controllers\Api\Tenant\V1\CourtScheduleController;
...
use App\Http\Controllers\Api\Tenant\V1\ReservationController;
...
Route::prefix('v1')->middleware(['auth:sanctum', 'company.filter'])->group(function () {
    ...
    Route::post('apps/{key}/addon', [AppAddonController::class, 'attach'])->middleware('billing.manage')->name('tenant.apps.addon.attach');
    Route::delete('apps/{key}/addon', [AppAddonController::class, 'detach'])->middleware('billing.manage')->name('tenant.apps.addon.detach');
    Route::post('apps/plan', PlanSwitchController::class)->middleware('billing.manage')->name('tenant.apps.plan.switch');
    ...
    Route::post('billing/checkout', [BillingController::class, 'checkout'])->middleware('billing.manage')->name('tenant.billing.checkout');
    Route::patch('billing/subscription/status', [BillingController::class, 'updateSubscriptionStatus'])
    ...
    Route::patch('courts/{court}/toggle-status', [CourtController::class, 'toggleStatus'])->name('tenant.courts.toggle-status');
    Route::get('courts/form-options', [CourtController::class, 'formOptions'])->name('tenant.courts.form-options');
    Route::post('courts/batch-delete', [CourtController::class, 'batchDestroy'])->name('tenant.courts.batch-delete');
    Route::apiResource('courts', CourtController::class);

    Route::patch('court-schedules/{court_schedule}/toggle-status', [CourtScheduleController::class, 'toggleStatus'])->name('tenant.court-schedules.toggle-status');
    Route::get('court-schedules/form-options', [CourtScheduleController::class, 'formOptions'])->name('tenant.court-schedules.form-options');
    Route::post('court-schedules/batch-delete', [CourtScheduleController::class, 'batchDestroy'])->name('tenant.court-schedules.batch-delete');
    Route::apiResource('court-schedules', CourtScheduleController::class)->parameters(['court-schedules' => 'court_schedule']);

    Route::patch('reservations/{reservation}/confirm', [ReservationController::class, 'confirm'])->name('tenant.reservations.confirm');
    Route::patch('reservations/{reservation}/cancel', [ReservationController::class, 'cancel'])->name('tenant.reservations.cancel');
    Route::patch('reservations/{reservation}/mark-paid', [ReservationController::class, 'markPaid'])->name('tenant.reservations.mark-paid');
    Route::patch('reservations/{reservation}/mark-played', [ReservationController::class, 'markPlayed'])->name('tenant.reservations.mark-played');
    Route::patch('reservations/{reservation}/mark-no-show', [ReservationController::class, 'markNoShow'])->name('tenant.reservations.mark-no-show');
    Route::get('reservations/form-options', [ReservationController::class, 'formOptions'])->name('tenant.reservations.form-options');
    Route::post('reservations/batch-delete', [ReservationController::class, 'batchDestroy'])->name('tenant.reservations.batch-delete');
